...
//		assertEquals(algoM.ermittleKuerzestenWege(4).toString(), "{0=3, 1=0, 2=7, 3=3, 4=7, 5=13}");
//		assertEquals(algoM.ermittleKuerzestenWege(5).toString(), "{0=10, 1=7, 2=6, 3=7, 4=0, 5=6}");
	}
	...
	public void TestListeKlein()
	{
		...
		assertEquals(algoL.ermittleKuerzestenWege(4).toString(), "{0=3, 1=0, 2=7, 3=3, 4=7, 5=13}");
		assertEquals(algoL.ermittleKuerzestenWege(5).toString(), "{0=10, 1=7, 2=6, 3=7, 4=0, 5=6}");
